...
lxybot = telegram.Bot("something really secret")

TOKEN = "something really secret" #This is for the authentication of the bot.
...
def getUpdates(offset=None): # Returns a JSON object representing the events that occur during interacting with the bot.
